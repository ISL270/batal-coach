...
import 'package:btl/app/coach/features/add_client/presentation/bloc/add_client_cubit.dart' as _i249;
...
import 'package:btl/app/coach/features/exercises/domain/repositories/exercises_repository.dart'
    as _i611;
import 'package:btl/app/coach/features/exercises/presentation/bloc/exercises_bloc.dart' as _i450;
...
import 'package:btl/app/coach/features/workouts/data/sources/remote/workout_firestore_source.dart'
    as _i389;
import 'package:btl/app/coach/features/workouts/domain/workout_repository.dart' as _i820;
...
import 'package:btl/app/features/settings/data/sources/local/settings_isar_source.dart' as _i557;
import 'package:btl/app/features/settings/domain/settings_repository.dart' as _i662;
import 'package:btl/app/features/settings/settings/settings_bloc.dart' as _i1055;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.singleton<_i557.SettingsIsarSource>(() => _i557.SettingsIsarSource(gh<_i26.IsarService>()));
    gh.singleton<_i193.UserIsarSource>(() => _i193.UserIsarSource(gh<_i26.IsarService>()));
    gh.singleton<_i374.ClientsIsarSource>(() => _i374.ClientsIsarSource(gh<_i26.IsarService>()));
    gh.singleton<_i25.WorkoutIsarSource>(() => _i25.WorkoutIsarSource(gh<_i26.IsarService>()));
    ...
    gh.factory<_i1055.SettingsBloc>(() => _i1055.SettingsBloc(gh<_i662.SettingsRepository>()));
    ...
    gh.factory<_i441.ClientsBloc>(() => _i441.ClientsBloc(gh<_i1006.ClientsRepository>()));
    gh.factory<_i249.AddClientCubit>(() => _i249.AddClientCubit(gh<_i1006.ClientsRepository>()));
    gh.factory<_i450.ExercisesBloc>(() => _i450.ExercisesBloc(gh<_i611.ExercisesRepository>()));
