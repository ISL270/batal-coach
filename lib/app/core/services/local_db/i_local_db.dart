...
abstract interface class LocalDB {
  ...
  Future<T?> get<T extends CacheModel>(String id);
  Future<List<T>> getAll<T extends CacheModel>();
  Future<List<T>> getAllByIDs<T extends CacheModel>(List<String> ids);
  ...
  Future<int> deleteAll<T extends CacheModel>(List<String> ids);
